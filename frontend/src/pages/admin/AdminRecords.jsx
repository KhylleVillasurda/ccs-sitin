  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '1.25rem', alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        <span style={{ marginLeft: 'auto', fontSize: '0.8rem', color: 'var(--fg-dim)' }}>
          ...
          <tbody>
            {loading ? (
              ...
              <tr key={r.id}>
                ...
                <td style={{ color: 'var(--fg-dim)', fontSize: '0.85rem' }}>Lab {r.lab}</td>
                <td style={{ color: 'var(--fg-dim)', fontSize: '0.85rem' }}>{r.session}</td>
                <td>
